     ...
     ////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $dir_pics = (isset($_GET['pics']) ? $_GET['pics'] : $dir_dest);
            ...
            if ($handle->uploaded) {
                ...
                $handle->file_new_name_body = "NWS".uniqid()."U".$_SESSION['user_id']."T".time(); 
                ...
                if ($handle->processed) {
                 ...
                 $stmt=$con->prepare("INSERT into news(title,body,main_image,biz_id,author) values(?,?,?,?,?)") or die($con->error);
                 $stmt->bind_param("sssss",$title,$body,$handle->file_dst_name,$_SESSION['company_id'],$_SESSION['user_id']) or die($con->error); 
